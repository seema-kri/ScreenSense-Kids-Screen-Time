...
### Behavioral Risk Segmentation & Health Impact Analytics — Python + Power BI
...
> A behavioral analytics study identifying which children are most at risk of screen overexposure, which devices drive it, and what measurable health outcomes follow — translated into a 5-page Power BI dashboard and a ranked, feasibility-scored set of recommendations for parents, schools, and policymakers.
...
**Data proof:** 8,874 of 9,668 children exceed daily screen time limits (91.75%). Only 794 children (8.25%) fall within safe usage.
...
**Explanation:** The 8–10 group is the **only age group** where educational usage naturally dominates — likely due to parental supervision. From age 11 onward, recreational usage takes over permanently. This transition window (ages 10–11) is the most critical point for behavioral intervention.
...
**Explanation:** Poor sleep is nearly 3.5× more prevalent than the next health impact (eye strain). The 11–13 age group records the highest absolute count of poor sleep cases (665 children), suggesting late-night device use begins in early adolescence.
...
| Microsoft Power BI | Interactive 5-page dashboard + insights summary |
...
├── Overview.png                 # Dashboard Page 1 screenshot
├── Device & Activity.png        # Dashboard Page 2 screenshot
├── Health impact.png            # Dashboard Page 3 screenshot
├── Segmentation.png             # Dashboard Page 4 screenshot
├── Insights.png                 # Dashboard Page 5 screenshot
...
**Seema Kumari**
Data Analyst | Python · SQL · Power BI | Behavioral analytics, risk segmentation, and KPI-driven dashboards
